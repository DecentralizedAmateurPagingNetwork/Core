...
public class Raspager1 extends TransmitterDevice {
    private static final Logger logger = LogManager.getLogger(Raspager1.class.getName());
    ...
    public Raspager1(Transmitter transmitter, TransmitterDeviceListener listener) {
        ...
        this.transmitterDeviceProtocol = new RaspagerProtocol();
    }
